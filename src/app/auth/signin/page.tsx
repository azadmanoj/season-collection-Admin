...
export const metadata: Metadata = {
  title: " Season Collection Admin SignIn  |  Season Collection Admin",
  description: "This is  Season Collection Admin Signin ",
};
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              ...
              <p className="2xl:px-20">
                This portal is for admin. Only Admin will have the access to
                login .
              </p>
